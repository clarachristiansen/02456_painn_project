...
sweep_config = {
    ...
    'parameters': {
        'num_message_passing_layers': {'values': [2, 3, 4]}, # [2, 3, 4, 5]
        'lr': {'values': [1e-3, 1e-4]}, # [1e-3, 5e-4, 1e-4]
        #'batch_size_train': {'values': [32, 64, 100]},
        'weight_decay': {'values': [0.01, 0.001, 0.0001]} # [0.01, 0.001, 0.0001]
    }
}

sweep_id = wandb.sweep(sweep_config, project="QM9_PaiNN_wandb_noclip")
